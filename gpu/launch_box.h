#ifndef PLAS_GPU_LAUNCH_BOX_H_
#define PLAS_GPU_LAUNCH_BOX_H_
...
struct launch_box_default_t {
  ...
  typedef empty_t sm_30, sm_32, sm_35, sm_37, sm_50, sm_52, sm_53, sm_60, sm_61,
      sm_62, sm_70, sm_75, sm_80, sm_86;
...
struct launch_box_t : inherit_t<params_v..., launch_box_default_t> {
  ...
  typedef typename conditional_typedef_t<typename base_t::sm_30,
                                         typename base_t::sm_00>::type_t sm_30;

#define INHERIT_LAUNCH_PARAMS(new_ver, old_ver)                         \
  typedef typename conditional_typedef_t<typename base_t::sm_##new_ver, \
                                         sm_##old_ver>::type_t sm_##new_ver;
  ...
  typedef sm_86 sm_00;
  typedef PLAS_LAUNCH_PARAMS(launch_box_t) sm_ptx;
...
int occupancy(func_t f, const context_t& context, args_t... args) {
  ...
  cudaError_t result = cudaOccupancyMaxActiveBlocksPerMultiprocessor(
      &num_blocks, &launch_box_cta_k<launch_box, func_t, args_t...>, nt,
      (size_t)0);
